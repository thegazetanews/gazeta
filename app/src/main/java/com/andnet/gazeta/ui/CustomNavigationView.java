...
//        System.out.println("mMenuView:" + mMenuView + " mButtons:" + mButtons + " mOnClickListener" + mOnClickListener);
     ...
     * necessary calls back to the provided {@link CustomNavigationView} so that the tab position is
     * kept in sync.
     * <p>
    ...
    private static class BottomNavigationViewExOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<CustomNavigationView> mBnveRef;

        public BottomNavigationViewExOnPageChangeListener(CustomNavigationView bnve) {
        ...
        public void onPageSelected(final int position) {
            final CustomNavigationView bnve = mBnveRef.get();
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, CustomNavigationView bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
