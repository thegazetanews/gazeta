...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private static final int COLOR_UNCHECKED = 0x00ffffff/*Color.WHITE*/;
    private static final int COLOR_CHECKED = Color.parseColor("#0288D1");
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, AndroidUtilities.dp2px(getContext(), 0));
        ta.recycle();
        ...
        mTickPoints[0] = new Point();  toggle();
//                mTickDrawing = false;
//                mDrewDistance = 0;
//                if (isChecked()) {
...
//
    ...
    private int measureSize(int measureSpec) {
        int defSize = AndroidUtilities.dp2px(getContext(), DEF_DRAW_SIZE);
